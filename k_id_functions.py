...
@numpy.vectorize
def k_id_generator(x, y, x_grid_interval=1 / 100, y_grid_interval=1 / 100, id_length=8):
    """
...
def bound_box_k_id(k_id, x0=57.7350269122104, y0=39.9999999964079, x_grid_len=47, y_grid_len=42,
                   x_grid_interval=1 / 100, y_grid_interval=1 / 100):
    """
    Parameters
    ----------
    k_id : int
...
# def lon_lat_from_origin_and_k_id(k_id, x0=57.7350269122104,y0=39.9999999964079, x_grid_len=30,y_grid_len=32,
# x_grid_interval=1/10000, y_grid_interval=1/10000):

def lat_lon_k_id(k_id, x0=57.7350269122104, y0=39.9999999964079, x_grid_len=47, y_grid_len=42, x_grid_interval=1 / 100,
                 y_grid_interval=1 / 100):
    """
...
def check_xy_in_bbox(x, y, k_id, x0=57.7350269122104, y0=39.9999999964079, x_grid_len=47, y_grid_len=42,
                     x_grid_interval=1 / 100, y_grid_interval=1 / 100):
    """
